...
python3 m2-golden/gen_mlkem_decaps_b_vectors.py

echo "[2/3] Kaannetaan RTL + testipenkki..."
iverilog -g2012 -o sim/m3_mlkem_decaps_b_sim \
  ...
  tb/pqc_mlkem_decaps_b_tb.sv

echo "[3/3] Ajetaan simulaatio..."
timeout 90 vvp sim/m3_mlkem_decaps_b_sim
