...
python3 m2-golden/gen_kpke_keygen_full_vectors.py

echo "[2/3] Kaannetaan RTL + testipenkki..."
iverilog -g2012 -o sim/m3_kpke_keygen_full_sim \
  ...
  tb/pqc_kpke_keygen_full_tb.sv

echo "[3/3] Ajetaan simulaatio..."
vvp sim/m3_kpke_keygen_full_sim
