...
python3 m2-golden/gen_se_vectors.py

echo "[2/3] Kaannetaan RTL + testipenkki..."
iverilog -g2012 -o sim/m3_se_vectors_sim \
  ...
  rtl/pqc_prf_samplepolycbd.sv tb/pqc_se_vectors_tb.sv

echo "[3/3] Ajetaan simulaatio..."
vvp sim/m3_se_vectors_sim
