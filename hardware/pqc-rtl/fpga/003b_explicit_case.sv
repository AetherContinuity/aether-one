    ...
    if (NTT_READ_LATENCY == 0) begin : g_comb_read
      ...
      always_comb begin
        case (pb_a0_reg)
          ...
          2'd2: rdata_a0 = b2_out_a0; 2'd3: rdata_a0 = b3_out_a0;
        endcase
        case (pb_b0_reg)
          2'd0: rdata_b0 = b0_out_b0; 2'd1: rdata_b0 = b1_out_b0;
          2'd2: rdata_b0 = b2_out_b0; 2'd3: rdata_b0 = b3_out_b0;
        endcase
        case (pb_a1_reg)
          2'd0: rdata_a1 = b0_out_a1; 2'd1: rdata_a1 = b1_out_a1;
          2'd2: rdata_a1 = b2_out_a1; 2'd3: rdata_a1 = b3_out_a1;
        endcase
        case (pb_b1_reg)
          2'd0: rdata_b1 = b0_out_b1; 2'd1: rdata_b1 = b1_out_b1;
          2'd2: rdata_b1 = b2_out_b1; 2'd3: rdata_b1 = b3_out_b1;
        endcase
      end
    end
  endgenerate
