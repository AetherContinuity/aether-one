module pqc_ntt_wrapper (
  ...
  pqc_ntt_stage_banked #(.NTT_READ_LATENCY(1), .FPGA_BRINGUP(1)) core (
  ...
  // Rekisteroidaan KAIKKI ulostulot, MUKAAN LUKIEN datariippuvainen
  // read_data (pitaa muistin sisallon havaittavana synteesille -
  // sama periaate kuin FPGA_BRINGUP:n oma tarkoitus).
