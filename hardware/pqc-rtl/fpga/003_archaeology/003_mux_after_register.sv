...
module pqc_003_mux_after_register #(
  ...
  generate
    if (NTT_READ_LATENCY == 0) begin : g_comb_read
      ...
      // M4-FPGA-003: MUX VASTA REKISTEROINNIN JALKEEN - jokainen
      // pankki saa OMAN dedikoidun rekisterinsa (paivittyy JOKA
      // sykli, riippumatta valitsimesta), ja lopullinen rdata
      // valitaan NAISTA NELJASTA rekisterista KOMBINATORISESTI.
      logic [COEFF_W-1:0] b0_out_a0, b1_out_a0, b2_out_a0, b3_out_a0;
      logic [COEFF_W-1:0] b0_out_b0, b1_out_b0, b2_out_b0, b3_out_b0;
      logic [COEFF_W-1:0] b0_out_a1, b1_out_a1, b2_out_a1, b3_out_a1;
      logic [COEFF_W-1:0] b0_out_b1, b1_out_b1, b2_out_b1, b3_out_b1;
      logic [1:0] pb_a0_reg, pb_b0_reg, pb_a1_reg, pb_b1_reg;

      always_ff @(posedge clk) begin
        b0_out_a0 <= bank0[pl_a0]; b1_out_a0 <= bank1[pl_a0];
        b2_out_a0 <= bank2[pl_a0]; b3_out_a0 <= bank3[pl_a0];
        b0_out_b0 <= bank0[pl_b0]; b1_out_b0 <= bank1[pl_b0];
        b2_out_b0 <= bank2[pl_b0]; b3_out_b0 <= bank3[pl_b0];
        b0_out_a1 <= bank0[pl_a1]; b1_out_a1 <= bank1[pl_a1];
        b2_out_a1 <= bank2[pl_a1]; b3_out_a1 <= bank3[pl_a1];
        b0_out_b1 <= bank0[pl_b1]; b1_out_b1 <= bank1[pl_b1];
        b2_out_b1 <= bank2[pl_b1]; b3_out_b1 <= bank3[pl_b1];
        pb_a0_reg <= pb_a0; pb_b0_reg <= pb_b0;
        pb_a1_reg <= pb_a1; pb_b1_reg <= pb_b1;
      end

      always_comb begin
        case (pb_a0_reg)
          2'd0: rdata_a0 = b0_out_a0; 2'd1: rdata_a0 = b1_out_a0;
          2'd2: rdata_a0 = b2_out_a0; default: rdata_a0 = b3_out_a0;
        endcase
        case (pb_b0_reg)
          2'd0: rdata_b0 = b0_out_b0; 2'd1: rdata_b0 = b1_out_b0;
          2'd2: rdata_b0 = b2_out_b0; default: rdata_b0 = b3_out_b0;
        endcase
        case (pb_a1_reg)
          2'd0: rdata_a1 = b0_out_a1; 2'd1: rdata_a1 = b1_out_a1;
          2'd2: rdata_a1 = b2_out_a1; default: rdata_a1 = b3_out_a1;
        endcase
        case (pb_b1_reg)
          2'd0: rdata_b1 = b0_out_b1; 2'd1: rdata_b1 = b1_out_b1;
          2'd2: rdata_b1 = b2_out_b1; default: rdata_b1 = b3_out_b1;
        endcase
      end
    end
  endgenerate
