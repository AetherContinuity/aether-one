// M5-DILITHIUM-001 DK1-testi: koko 256-kertoimisen NTT:n todennus
// dilithium-py:n omaa to_ntt()-tulosta vasten.

`timescale 1ns/1ps

module pqc_dilithium_ntt_core_tb;
  ...
  initial begin
    ...
    if (coeffs_out === expect_out) begin
      $display("PASS: koko NTT tasmaa taydellisesti kaikille 256 kertoimelle");
    end else begin
      int diffs;
      diffs = 0;
