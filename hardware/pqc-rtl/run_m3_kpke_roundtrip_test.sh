...
python3 m2-golden/gen_kpke_roundtrip_vectors.py

echo "[2/3] Kaannetaan RTL + testipenkki..."
iverilog -g2012 -o sim/m3_kpke_roundtrip_sim \
  rtl/pqc_keccak_f1600.sv rtl/pqc_keccak_pad.sv rtl/pqc_keccak_absorb.sv \
  rtl/pqc_keccak_squeeze.sv rtl/pqc_shake128.sv rtl/pqc_shake256.sv rtl/pqc_sha3_512.sv \
  ...
  rtl/pqc_compress.sv rtl/pqc_batch_compress.sv rtl/pqc_batch_decompress.sv \
  rtl/pqc_byteencode_dparam.sv rtl/pqc_byteencode_d1.sv \
  tb/pqc_kpke_roundtrip_tb.sv

echo "[3/3] Ajetaan simulaatio..."
vvp sim/m3_kpke_roundtrip_sim
