...
iverilog -g2012 -o sim/m2_full_banked_sim rtl/pqc_rvv_cluster_2lane.sv rtl/pqc_ntt_stage_banked.sv tb/pqc_ntt_full_banked_tb.sv

echo "[3/3] Ajetaan simulaatio..."
vvp sim/m2_full_banked_sim
